# -*- coding: utf-8 -*-
"""
Just InCard v11.2 für Android/Kivy
...
- scannerzentrierte v11.2-KI-Ensemble-Pipeline mit Zeitbudgets, lokaler Sofortsuche, Bildqualitaetspruefung,
...
# KI-Scanner v11.2: lokaler Modellstapel fuer Galerie-Genauigkeit
...
def build_ui_profile(metrics=None, window_size=None):
    """Erstellt das zentrale v11.2-UI-Profil für Android-Fenster jeder Größe.
...
class YuGiOhApp(App):
    ...
    def show_home_page(self, *_):
        """Moderne v11.2-Startseite mit klaren Aktionen und sicheren Höhen."""
        current = getattr(self, "_active_inline_page", None)
    ...
    def run_integrity_check_v104(self):
        ...
        try:
            ...
            self.append_crash_log(exc, "Security v11.2")
    ...
    def apply_responsive_layout(self, force=False):
        """Legt die v11.2-Oberfläche anhand der nutzbaren Fensterbreite neu aus.
        ...
        try:
            ...
            # Suchkarte: Spalten folgen dem zentral getesteten v11.2-Profil.
    ...
    def open_camera_scanner(self):
        """Vollflächiger Live-Scanner v11.2 mit automatischer Erkennung.
    ...
    def open_scan_timing_popup(self, *_):
        ...
        lines = [
            ...
            "",
            "KI-Ensemble v11.2: " + model_stack_summary(),
            "",
    ...
    def detect_card_regions(self, path, max_cards=64):
        """Multi-Engine-Erkennung für Galerie-/Ordnerseiten in v11.2.
    ...
    def show_bulk_gallery_review_popup(self, results, errors):
        ...
        # v11.2: Keine Gruppierung über verschiedene Bildquellen mehr. Jeder
