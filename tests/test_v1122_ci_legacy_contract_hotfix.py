# -*- coding: utf-8 -*-
"""Regressionstest für den GitHub-Actions-Abbruch vor dem APK-Build in v11.2.2."""
...
def run():
    ...
    assert "tests/test_v1122_ci_legacy_contract_hotfix.py" in workflow
    ...
    print("v11.2.2 GitHub Actions legacy-contract hotfix tests: OK")
