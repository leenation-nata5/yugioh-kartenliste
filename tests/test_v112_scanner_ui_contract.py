# -*- coding: utf-8 -*-
"""Regressionstest für Scanner-, Galerie-, UI- und Erststart-Änderungen in v11.3.0."""
...
def run():
    ...
    assert manifest["version"] == "11.3.0"
    ...
    print("v11.3.0 scanner/UI/first-launch contract tests: OK")
